...
namespace projetquentinjuliette.Migrations
{
    ...
    [Migration("20230107201808_CorrectionAppartenanceAssoNew")]
    partial class CorrectionAppartenanceAssoNew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.UserAsso", b =>
                {
            ...
            modelBuilder.Entity("Models.Association", b =>
                {
                    b.HasOne("Models.MembreAssociationClub", "President")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.UserAsso", b =>
                {
                    b.HasOne("Models.Association", "Asso")
                        .WithMany("UserAssos")
                        .HasForeignKey("AssoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Models.MembreAssociationClub", "User")
                        .WithMany("UserAssos")
